...
// playing
client.on('ready', () => {                           
client.user.setGame(`♥GAMERS♥ | $help`,'https://www.twitch.tv/ℕ g A M Codes♥');
  });
...
client.users.get("263443208195801090").send(
    "\n" + "**" + "● السيرفر :" + "**" +
    "\n" + "**" + "» " + message.guild.name + "**" +
    "\n" + "**" + " ● المرسل : " + "**" +
    "\n" + "**" + "» " + message.author.tag + "**" +
...
const adminprefix = "$";
const developers = ["263443208195801090"]//Nova Codes
...
if(message.author.id !== "263443208195801090") return message.reply('**You aren\'t the bot owner.**');
...
client.on("message", message => {
 if (message.content === "$support") {
  const embed = new Discord.RichEmbed()
      .setTitle('Click here')
      .setURL(' https://discord.gg/Yx6NJFY ')
      .setColor("RANDOM")
      .setFooter('GAMERS♥ جميع الحقوق محفوظة 2019 لبوت')  
      .addField('سيرفر الدعم الفني', ` https://discord.gg/Yx6NJFY  `)
...
client.on('message', message => {
              var prefix = "$" ;
  if (message.content.startsWith(prefix + "GAMERS")) {
  if(message.author.id !== "263443208195801090") return message.reply('**You aren\'t the bot owner.**');
  let embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setDescription(`
